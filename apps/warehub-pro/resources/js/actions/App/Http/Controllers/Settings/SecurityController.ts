...
* @route '//central.warehub.test/settings/security'
*/
...
edit.definition = {
    methods: ["get","head"],
    url: '//central.warehub.test/settings/security',
...
* @route '//central.warehub.test/settings/password'
*/
...
update.definition = {
    methods: ["put"],
    url: '//central.warehub.test/settings/password',
