...
/**
* @see \App\Http\Controllers\Tenant\CustomerController::index
* @see app/Http/Controllers/Tenant/CustomerController.php:17
* @route '/customers'
*/
...
/**
* @see \App\Http\Controllers\Tenant\CustomerController::create
* @see app/Http/Controllers/Tenant/CustomerController.php:26
...
/**
* @see \App\Http\Controllers\Tenant\CustomerController::store
* @see app/Http/Controllers/Tenant/CustomerController.php:31
* @route '/customers'
*/
...
/**
* @see \App\Http\Controllers\Tenant\CustomerController::edit
* @see app/Http/Controllers/Tenant/CustomerController.php:38
...
/**
* @see \App\Http\Controllers\Tenant\CustomerController::update
* @see app/Http/Controllers/Tenant/CustomerController.php:45
...
/**
* @see \App\Http\Controllers\Tenant\CustomerController::destroy
* @see app/Http/Controllers/Tenant/CustomerController.php:52
* @route '/customers/{customer}'
*/
...
const CustomerController = { index, create, store, edit, update, destroy }
