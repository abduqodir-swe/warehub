...
* @see app/Http/Controllers/Tenant/ProductController.php:17
* @route '/products'
*/
...
* @see app/Http/Controllers/Tenant/ProductController.php:33
...
* @see app/Http/Controllers/Tenant/ProductController.php:45
...
* @see app/Http/Controllers/Tenant/ProductController.php:52
...
* @see app/Http/Controllers/Tenant/ProductController.php:59
* @route '/products/{product}'
*/
