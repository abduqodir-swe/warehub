...
* @see app/Http/Controllers/Tenant/OutgoingDocumentController.php:97
* @route '/outgoing/pos'
*/
...
const OutgoingDocumentController = { pos, posStore, index, create, store, show, confirm, destroy }
