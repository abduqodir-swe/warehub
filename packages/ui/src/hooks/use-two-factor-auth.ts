...
export type TwoFactorRoute = () => UrlMethodPair;

export type UseTwoFactorAuthOptions = {
    qrCode: TwoFactorRoute;
    secretKey: TwoFactorRoute;
    recoveryCodes: TwoFactorRoute;
};
...
export const useTwoFactorAuth = (
    ...
    const { qrCode, secretKey, recoveryCodes } = options;
